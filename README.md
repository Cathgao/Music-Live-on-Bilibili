...
本项目依赖FFMPEG，请将FFMPEG加入到系统path

本项目目前使用的是网易云音乐作为歌曲源，[GD音乐台(music.gdstudio.xyz)](https://music-api.gdstudio.xyz/api.php)作为音乐API

要填好config.json的配置项

本人Python只是自学的，大量AI代码，轻喷🥺

## 我的修改：
大幅重构代码，以后主要在`push_AB`分支更新，原来的master分支可能不再更新
